...
public class Comment {
     ...
     * The comment will only contain the content and the
     * information of the use who posted it
     * @param texts The texts included in the comment
     * @param images images that the user uploaded
     * @param postedBy The posted by is the user that write the comment
     */
    ...
    /**
     * Extract the image that the user used in the comment
     * @return image provided in the comment
     */
     ...
     * @param images that wants to include in the comment
     */
